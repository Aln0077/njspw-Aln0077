  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-blue-300/40 via-stone-100 to-amber-50/30">
      ...
      <div className="absolute left-6 md:left-12 bottom-12 z-30 flex flex-col gap-6">
        <motion.a
          href="https://www.linkedin.com/in/alan-perez-28b313319/"
          target="_blank"
      ...
      <div className="relative z-20 min-h-screen flex items-center justify-center px-8">
        <div className="text-center max-w-6xl">
          ...
          <div className="overflow-hidden mb-8">
            <motion.h1
              className="text-5xl md:text-7xl lg:text-8xl font-medium text-gray-900 leading-tight tracking-tight"
          ...
          {/* Your Name */}
          <motion.p
            className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-700 tracking-wide"
